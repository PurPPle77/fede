...
$sql = 'SELECT titre, accroche, texte, date_publication FROM articles ';
$articles = $db_connexion->query($sql)->fetchAll();

foreach ($articles as $article) {  // ici je cree le tableau "article" qui contient les données de la table "articleS" de la base de données
  $article = orderBy('date_publication', 'DESC');
}
...
?>
      ...
      <!-- Deuxième tuile -->
      <!-- <div class="tuile">
        <img src="./images/actu2.jpg" alt="Image Actualité 1">
        <h3><?php echo $article['titre']; ?></h3>
        <p><?php echo $article['accroche']; ?></p>
        <p><?php echo $article['texte']; ?></p>
        <p><?php echo $article['date_publication']; ?></p>
      ...
      <!-- Troisième tuile -->
      <!-- <div class="tuile">
        <img src="./images/actu3.jpg" alt="Image Actualité 1">
        <h3><?php echo $article['titre']; ?></h3>
        <p><?php echo $article['accroche']; ?></p>
        <p><?php echo $article['texte']; ?></p>
        <p><?php echo $article['date_publication']; ?></p>
