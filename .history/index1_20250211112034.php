...
$sql = 'SELECT titre, accroche, texte FROM articles';
$articles = $db_connexion->query($sql)->fetchAll();

foreach ($article as $articles) {  // ici je cree le tableau "articles" qui contient les données de la table "article" de la base de données
}
...
?>
      <div class="tuile">
        ...
        <p><?php echo $articles['accroche']; ?></p>
