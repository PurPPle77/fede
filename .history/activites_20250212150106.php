...
<form method="POST" action="ton_script.php">
    <input type="checkbox" name="activites[]" value="Activite 1"> Activité 1<br>
    <input type="checkbox" name="activites[]" value="Activite 2"> Activité 2<br>
    <input type="checkbox" name="activites[]" value="Activite 3"> Activité 3<br>
