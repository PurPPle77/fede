...
$sql = 'SELECT titre, accroche, texte, date_publication FROM articles ORDER BY date_publication DESC LIMIT 3';
...
<!-- ici je cree le tableau "article" qui contient les données de la table "articleS" de la base de données 
 et je les affiche dans la page index.php-->

 <!-- je dois mettre le foreach ici pour englober les données et non pas seul en haut, ce qui n'a pas de sens vu que ca foreach rien...cela permet aussi de generer le code de la classe tuile et donc d'ne creer une nouvelle suivant la limite que j'ai fixée dans la requete sql-->
