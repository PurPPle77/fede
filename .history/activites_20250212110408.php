...
$sql = 'SELECT GroupeActivite FROM Activites;  // ici je crée une requete sql qui me permet de récupérer les 3 derniers articles de la table "articles" de la base de données et de les trier par date de publication décroissante.
