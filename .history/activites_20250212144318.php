...
<form method="post" action="">
    <h3>Choisissez un groupe d'activité :</h3>
    
    <?php
	foreach ($activitesUnik as $group) {
		echo '<input type="checkbox" name="activites[]" value="' . htmlspecialchars($group) . '">';
		echo '<label>' . htmlspecialchars($group) . '</label><br>';
	}
	?>
